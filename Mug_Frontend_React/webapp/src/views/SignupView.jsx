...
export default function SignupView({
  ...
  onFirstNameChange, onLastNameChange, onUsernameChange, onPasswordChange, onPhoneChange,
    ...
    <main className="view auth-view">
      <div className="auth-bg">
        ...
        <div className="auth-card">
          <div className="auth-title">Join the exchange</div>

          <div style={{ display:"flex", gap:10 }}>
            <div className="field" style={{ flex:1 }}>
              <label htmlFor="signup-firstname">First name</label>
              <input id="signup-firstname" className="input" placeholder="First"
                autoComplete="given-name" value={firstName}
                onChange={(e) => onFirstNameChange(e.target.value)} />
            </div>
            <div className="field" style={{ flex:1 }}>
              <label htmlFor="signup-lastname">Last name</label>
              <input id="signup-lastname" className="input" placeholder="Last"
          ...
          <div className="field">
            ...
            <input id="signup-username" className="input" placeholder="your_username"
          ...
          <div className="field">
            ...
            <div style={{position:"relative"}}>
              <input id="signup-password" className="input" type={showPw ? "text" : "password"} placeholder="••••••••"
          ...
          <div className="field">
            ...
            <input id="signup-phone" className="input" type="tel" placeholder="+1 555 000 0000"
      ...
      {showMission && (
        <div className="modal-overlay" onClick={() => setShowMission(false)}>
          <div className="modal-card" onClick={(e) => e.stopPropagation()}>
            ...
            <p className="modal-body">We're building a world where grabbing coffee in a reusable mug is the default — not the exception.</p>
            <div className="modal-items">
              {[
                ...
                <div key={title} className="modal-item">
                  ...
                  <div><div className="modal-item-title">{title}</div><div className="modal-item-body">{body}</div></div>
                </div>
              ))}
            </div>
          </div>
